...
#define ENTITY_HASHTABLE_DIMENSION 2333
...
struct relationTracker_2 * deleteRelationTracker_2(struct relation * relation, struct relationTracker_2 * z);
...
struct relationSentToOrReceivedFrom * deleteRelationSentToOrReceivedFrom(struct relationSentToOrReceivedFrom * z, struct relationSentToOrReceivedFrom ** head);
